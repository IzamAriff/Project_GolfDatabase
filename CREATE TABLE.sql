...
CREATE TABLE ItemInventory (
    ...
    CONSTRAINT FK_I_Order FOREIGN KEY (O_OrderID) REFERENCES Orders (O_OrderID) ON DELETE CASCADE,
...
CREATE TABLE PersonOrder (
    ...
    CONSTRAINT ET_PO_Order FOREIGN KEY (PO_OrderID) REFERENCES Orders (O_OrderID) ON DELETE CASCADE,
...
CREATE TABLE OrderPayment (
    ...
    CONSTRAINT ET_OPA_Invoice FOREIGN KEY (OPA_OrderID) REFERENCES Orders (O_OrderID) ON DELETE CASCADE
);
